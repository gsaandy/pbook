...
- **SECTION_NAME** = [Human-readable name, e.g., "Setup & Configuration" or "Daily Operations"]
- **SECTION_ID** = [Folder name in sections/, e.g., "setup-and-configuration" or "daily-operations"]
