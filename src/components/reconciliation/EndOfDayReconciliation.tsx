...
import { IndianRupee, Wallet, CreditCard, CheckCircle2, AlertCircle, Download } from 'lucide-react'
import type { EndOfDayReconciliationProps, VerificationFormData } from '../../../product-plan/sections/end-of-day-reconciliation/types'
                      ...
                      >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-right">
                          {settlement.status === 'pending' ? (
                            <button
                              onClick={() => setVerifyingEmployee(settlement.employeeId)}
                            ...
                            <span className="text-sm text-slate-500 dark:text-slate-400">
                              {settlement.verifiedAt &&
                                new Date(settlement.verifiedAt).toLocaleTimeString('en-IN', {
                                  hour: '2-digit',
                                  minute: '2-digit',
                                })}
                            </span>
