...
export interface TrendData {
  dailyCollections: Array<DailyCollection>
  employeePerformance: Array<EmployeePerformance>
  paymentModeDistribution: Array<PaymentModeDistribution>
  topShops: Array<TopShop>
}
...
export interface FilterOptions {
  employees: Array<FilterOption>
  shops: Array<FilterOption>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {activeView === 'analytics' && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="bg-white dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700 p-5">
                ...
                <p className="text-lg font-bold text-slate-900 dark:text-white truncate">
                  {trendData.topShops[0]?.shopName || 'N/A'}
                </p>
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
            ...
            {trendData.employeePerformance.length > 0 && (
